...
RSpec.describe 'merchant show page', type: :feature do
  describe 'As a user' do
    before :each do
      ...
      @order_2 = @regular_user.orders.create!(name: 'Brian', address: '123 Zanti St', city: 'Denver', state: 'CO', zip: 80204)
      @order_3 = @regular_user.orders.create!(name: 'Mike', address: '123 Dao St', city: 'Denver', state: 'CO', zip: 80210)
      ...
      @order_2.item_orders.create!(status: "pending", item: @dog_bone, price: @dog_bone.price, quantity: 2)
      @order_2.item_orders.create!(status: "pending", item: @pull_toy, price: @pull_toy.price, quantity: 2)
      @order_2.item_orders.create!(status: "pending", item: @tire, price: @tire.price, quantity: 2)
      @order_3.item_orders.create!(status: "pending", item: @dog_bone, price: @dog_bone.price, quantity: 5)
    end
