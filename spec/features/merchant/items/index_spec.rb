...
RSpec.describe "As a merchant employee" do
  describe "When I visit my items page" do
    before(:each) do
      ...
      @zebra_tire = @meg.items.create!(name: "Zebraskins", description: "No zebras involved!", price: 200, image: "https://www.rei.com/media/4e1f5b05-27ef-4267-bb9a-14e35935f218?size=784x588", inventory: 22, active?: false)
    ...
    it "I can click a link or button to deactivate items" do
      ...
      expect(page).to have_content("#{@gator_tire.name} has been deactivated")
    end

    it "I can click a link or button to activate items" do
      ...
      expect(page).to have_content("#{@zebra_tire.name} has been activated")
    end
  end
end
