...
#merchants
bike_shop = Merchant.create(name: "Drew's Bike Shop", address: '123 Bike Rd.', city: 'Denver', state: 'CO', zip: 80203)
dog_shop = Merchant.create(name: "James's Dog Shop", address: '125 Doggo St.', city: 'Denver', state: 'CO', zip: 80210)
...
paper = chris.items.create(name: "Lined Paper", description: "Great for writing on!", price: 20, image: "https://cdn.vertex42.com/WordTemplates/images/printable-lined-paper-wide-ruled.png", inventory: 3)
pencil = chris.items.create(name: "Yellow Pencil", description: "You can write on paper with it!", price: 2, image: "https://images-na.ssl-images-amazon.com/images/I/31BlVr01izL._SX425_.jpg", inventory: 100)
...
merchant_user_1 = User.create!(name: "Mary Jane", address: "1234 Bland St.", city: "Denver", state: "CO", zip: "80085", email: "merchant_user_1@email.com", password: "123", role: 1, merchant_id: chris.id)
merchant_user_2 = User.create!(name: "Reza Atwal", address: "1234 Good St.", city: "Denver", state: "CO", zip: "80085", email: "merchant_user_2@email.com", password: "123", role: 1, merchant_id: garrett.id)
